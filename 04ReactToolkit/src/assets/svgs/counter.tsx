const CounterSVG = ({height,width}:any) => {
    return (
        <svg fill="#000000" height={height ?? "100%" } width={width ?? "100%" } version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 474.557 474.557">
            <g>
                <g>
                    <g>
